...
export enum GaugeEventActionType {
    ...
    ondialog = '打开对话框',
    oniframe = '打开链接',
    oncard = '打开卡片',     // wrong name exchange with 'onwindow'
    onSetValue = '设置变量值',
    onToggleValue = '设置开关变量值',
    onSetInput = '设置输入框',
    onclose = '关闭',
    onRunScript = '运行脚本',
}

export const GaugeEventActionTypes = [
    {
        label: '打开页面',
        value: 'onpage'
    },
...
export class TableColumn extends TableCellD {
